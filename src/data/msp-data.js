...
export const mspServicePrincipals = {
  HTT: [
    ...
    { name: "Office 365 Security Audit App", appId: "7aecb184-3fb1-437b-abc5-a995e972fe1f", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ NOT FOUND in live tenant (deleted) — verified via Graph API 2026-05-12 (reports/B2-B3-VERIFICATION-2026-05-12.md)" },
    { name: "Office365 Integration", appId: "bee5026c-2493-4557-bc21-ccef515d9e61", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ NOT FOUND in live tenant (deleted) — verified via Graph API 2026-05-12" },
    { name: "PshellTools", appId: "cc695ec2-07c4-454b-95bc-418f5a8047fc", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ NOT FOUND in live tenant (deleted) — verified via Graph API 2026-05-12" },
  ...
  FN: [
    { name: "Pax8", appId: "96b1dd76-7698-438b-9565-2e268be9ea34", owner: "Sui Generis Incorporated", ownerTenantId: "daee2992-bedc-4b96-840d-3cb1ffa89d10", type: "Application", enabled: true, created: "2026-03-10" },
    { name: "Office 365 Security Audit App", appId: "7aecb184-3fb1-437b-abc5-a995e972fe1f", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ VERIFIED DISABLED via Graph API 2026-05-12 (reports/B2-B3-VERIFICATION-2026-05-12.md)" },
    { name: "Office365 Integration", appId: "bee5026c-2493-4557-bc21-ccef515d9e61", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ VERIFIED DISABLED via Graph API 2026-05-12" },
    { name: "PshellTools", appId: "cc695ec2-07c4-454b-95bc-418f5a8047fc", owner: "AppRiver", ownerTenantId: "d5e2dca7-948b-4e7c-9d9e-af97e9ca0f92", type: "Application", enabled: false, created: "2025-12-22", disabledDate: "2026-04-10", note: "✅ VERIFIED DISABLED via Graph API 2026-05-12" },
    { name: "Riverside-Capital-PE-Governance-Platform", appId: "1e3e8417-49f1-4d08-b7be-47045d8a12e9", owner: "HTT Brands", ownerTenantId: "0c0e35dc-188a-4eb3-b8ba-61752154b407", type: "Application", enabled: true, created: "2026-03-30" },
  ...
  TLL: [
    ...
    { name: "O365Support-MSP-Connector", appId: "e5f67890-2345-6789-abcd-ef0123456789", owner: "'Office 365'", ownerTenantId: "b4c546a4-7dac-46a6-a7dd-ed822a11efd3", type: "Application", enabled: true, created: "2022-06-14", note: "⚠️ NOT FOUND in live TLL tenant via Graph API 2026-05-12 — SP may have been deleted or AppId was synthetic. Partner policy for office365support.com may still exist." },
  ],
  DCE: [
    { name: "Riverside-Capital-PE-Governance-Platform", appId: "1e3e8417-49f1-4d08-b7be-47045d8a12e9", owner: "HTT Brands", ownerTenantId: "0c0e35dc-188a-4eb3-b8ba-61752154b407", type: "Application", enabled: true, created: "2026-03-30" },
...
export const confirmedContext = {
  ...
  bishops: {
    ...
    action: "BCC Business Basic expires October 2026; other Pax8 renewals may land July/August. Confirm which SKUs need earlier action and align renewal dates per tenant.",
  ...
  billingMess: "Billing is fragmented but improving. BCC Business Basic expires October 2026; other Pax8 renewals may still land July/August — confirm if any require earlier action. Megan will consolidate to PAX8 and align renewal dates per tenant. TLL has only 2 active billing accounts (not the huge list feared). Power BI individual licenses being phased out (auto-assigned Fabric Free via cross-tenant sync). Some HTT Power BI + Teams Premium still direct-billed — migration in progress.",
...
export const callAgenda = [
  ...
  { id: "delta-crown", title: "Delta Crown — Model Tenant", time: "10 min", icon: "👑", description: "DCE current state walkthrough + spoke-side auto-redeem + DUNS/ABM unblock" },
