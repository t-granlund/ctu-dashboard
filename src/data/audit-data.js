...
export const unknownTenants = [
  ...
  { id: '248c9920-7745-4f81-8e18-1a5de9935bbd', resolvedName: 'Franworth', resolvedDomain: 'franworth.com', gdapStatus: 'Removed (1)', foundIn: [], flags: ['Full DC: AllUsers/AllApps both directions','NO MFA trust'], priority: 'resolved', resolved: true, resolvedDate: '2026-04-10', resolvedEvidence: 'reports/franworth-removal-executed.json', description: 'Franchise consulting firm. Full Direct Connect access to TLL with NO MFA trust — invisible access path. ✅ RESOLVED: Partner policy removed, 15 TLL + 4 HTT guest accounts disabled on 2026-04-10.', category: 'Former Business Partner' },
  { id: 'd5e2dca7-948b-4e7c-9d9e-af97e9ca0f92', resolvedName: 'AppRiver', resolvedDomain: 'appriver4us.onmicrosoft.com', gdapStatus: 'Removed (1)', foundIn: [], flags: [], priority: 'resolved', resolved: true, resolvedDate: '2026-04-10', resolvedEvidence: 'reports/appriver-disable_2026-04-10_165012.json', description: 'Email security/management service provider. ✅ RESOLVED: 9 service principals disabled across HTT, FN, TLL on 2026-04-10. Migration to PAX8 complete.', category: 'Former MSP/Service Provider' },
