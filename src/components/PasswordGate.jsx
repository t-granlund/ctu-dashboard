      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        >
          ...
          <input
            ...
            autoFocus
            className="mb-4 w-full rounded-xl border border-slate-700 bg-slate-800/80 px-4 py-3 text-sm text-white placeholder:text-slate-600 transition-colors focus:border-cyan-300 focus:ring-1 focus:ring-cyan-300/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300"
          />
          {error && (
            <p role="alert" className="mb-4 flex items-center gap-1.5 text-xs font-semibold text-red-300">
          ...
          <button
            ...
            className="w-full rounded-xl bg-[#7f1d2d] px-4 py-3 text-sm font-bold text-white shadow-lg shadow-[#500711]/30 transition-all hover:bg-[#9f2639] hover:shadow-[#500711]/40 disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        <div className="mt-8 flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] text-slate-500">Phase 1 Audit Complete</span>
          </div>
        </div>
      </div>
    </main>
